...
ele4 = driver.find_element(By.XPATH,"driver.find_element(By.XPATH,"//div[@id='outputcontent1']//h1[@class='f_headline'][normalize-space()='SRI GNANA SARASWATI DEVASTHANAM ROOM BOOKING BASAR']")")
ele4.click()
time.sleep(5)
...
for handle in all_handles:
    if handle != parent_handle:
        ...
        ele7.click()
        time.sleep(5)
        ele8 = driver.find_element(By.XPATH,"//a[@title='December 16']")
        ele8.click()
        time.sleep(5)
        ...
        # ele19 = driver.find_element(By.XPATH,"//select[@name='devoteedetails$ddlState']")
        # ele19.click()
        # ele19 = Select(ele19)
        # ele19.select_by_visible_text('Telangana')
        # time.sleep(5)
