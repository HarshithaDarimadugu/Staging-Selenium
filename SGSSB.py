...
class templesevaboooking():
    def sevabooking(self):
        ...
        ele4 = driver.find_element(By.XPATH,"//h1[normalize-space()='SRI GNANA SARASWATI DEVASTHANAM SEVA BOOKING BASAR']").click()
        time.sleep(5)
        ...
        for handle in all_handles:
            if handle !=parent_handle:
                ...
                ele5.select_by_visible_text('Abhishekam')
                time.sleep(5)
                
                ele6 = driver.find_element(By.XPATH,"//select[@name='ddlBatches']")
                ele6.click()
                ele6 = Select(ele6)
                ele6.select_by_visible_text('4:00 AM to 6:00 AM')
                time.sleep(5)
